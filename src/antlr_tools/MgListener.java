...
public interface MgListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MgParser#globalDec}.
	 * @param ctx the parse tree
	 */
	void enterGlobalDec(MgParser.GlobalDecContext ctx);
	/**
	 * Exit a parse tree produced by {@link MgParser#globalDec}.
	 * @param ctx the parse tree
	 */
	void exitGlobalDec(MgParser.GlobalDecContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MgParser#fieldDec}.
	 * @param ctx the parse tree
	 */
	void enterFieldDec(MgParser.FieldDecContext ctx);
	/**
	 * Exit a parse tree produced by {@link MgParser#fieldDec}.
	 * @param ctx the parse tree
	 */
	void exitFieldDec(MgParser.FieldDecContext ctx);
	/**
	 * Enter a parse tree produced by {@link MgParser#methodDec}.
	 * @param ctx the parse tree
	 */
	void enterMethodDec(MgParser.MethodDecContext ctx);
	/**
	 * Exit a parse tree produced by {@link MgParser#methodDec}.
	 * @param ctx the parse tree
	 */
	void exitMethodDec(MgParser.MethodDecContext ctx);
	/**
